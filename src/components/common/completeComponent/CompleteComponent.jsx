...
function CompleteComponent({buyer,items,total,id}) {    
        ...
        <div className="container">
          <div className="row text-center">
            <div className="col-sm-12 col-sm-offset-3">
              ...
              <h3>Estimado {buyer.nombre}, su orden fue procesada con éxito.<br></br><br></br> Su número de orden es: {id}</h3><br></br>
